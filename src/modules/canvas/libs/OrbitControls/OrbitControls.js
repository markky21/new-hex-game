...
var OrbitControls = function (object, domElement) {
  ...
  // CUSTOM: Box3 for pan boundaries
  this.panBoundaries = null;
  ...
  this.update = (function () {
    ...
    return function update() {
      ...
      // CUSTOM: Apply pan boundaries when target is out of scope
      if (scope.panBoundaries !== null) {
        scope.target.clamp(scope.panBoundaries.min, scope.panBoundaries.max);
      }
